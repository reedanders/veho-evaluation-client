...
export const initMessages = [
  ...
  },
  {
    ...
    content: [
      {
        timestamp: 1605291956318,
        user: { user: "Itamar Zur", image: hamarz },
        text:
